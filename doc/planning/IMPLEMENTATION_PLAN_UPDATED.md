...
- ✅ `source/binding/dds/idl/LapComMessage.idl` - IDL定义
- ✅ `source/binding/dds/idl/LapComMessage.h` - fastddsgen生成
- ✅ `source/binding/dds/idl/LapComMessagePubSubTypes.h` - TypeSupport
