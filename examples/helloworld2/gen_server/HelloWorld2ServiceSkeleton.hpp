/**
 * @file        HelloWorld2ServiceSkeleton.hpp
 * @author      Aii
 * @brief       Auto-generated service skeleton for HelloWorld2Service [SWS_CM_00002]
 * @date        2026/02/09
...
#ifndef HELLOWORLD2_HELLOWORLD2SERVICESKELETON_HPP
#define HELLOWORLD2_HELLOWORLD2SERVICESKELETON_HPP
...
namespace fields
{
    ...
    /**
     * @brief Service skeleton for HelloWorld2Service [SWS_CM_00002]
     * @note Auto-generated — non-copyable, move-only
     * @version 1.0.0
     */
    class HelloWorld2ServiceSkeleton : public ::lap::com::SkeletonBase {
    public:
         ...
         */
        explicit HelloWorld2ServiceSkeleton(
         ...
         */
        ~HelloWorld2ServiceSkeleton() noexcept override {
            if ( IsOffered() ) {
                StopOfferService();
            }
        }
        ...
        HelloWorld2ServiceSkeleton( HelloWorld2ServiceSkeleton&& ) noexcept = default;
        HelloWorld2ServiceSkeleton& operator=( HelloWorld2ServiceSkeleton&& ) noexcept = default;

        // Non-copyable [SWS_CM_11546, SWS_CM_11544]
        HelloWorld2ServiceSkeleton( const HelloWorld2ServiceSkeleton& ) = delete;
        HelloWorld2ServiceSkeleton& operator=( const HelloWorld2ServiceSkeleton& ) = delete;
...
#endif // HELLOWORLD2_HELLOWORLD2SERVICESKELETON_HPP
