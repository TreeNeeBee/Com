/**
 * @file        test_dbus_stub.cpp
 * @brief       D-Bus binding stub — verify all interfaces return kCommunicationFailure
 * @date        2026/02/07
 */
...
{
    std::printf( "========================================\n" );
    std::printf( "  D-Bus Binding Stub Test\n" );
    std::printf( "========================================\n\n" );
    ...
    CHECK( std::string( binding.GetName() ) == "DBus", "GetName() == DBus" );
    CHECK( binding.GetVersion() == 0x00010000U,        "GetVersion()" );
    CHECK( binding.GetPriority() == 20U,               "GetPriority() == 20" );
