/**
 * @file        test_socket_stub.cpp
 * @brief       Socket binding stub — verify all interfaces return kCommunicationFailure
 * @date        2026/02/07
 */
...
{
    std::printf( "========================================\n" );
    std::printf( "  Socket Binding Stub Test\n" );
    std::printf( "========================================\n\n" );
    ...
    CHECK( std::string( binding.GetName() ) == "Socket", "GetName() == Socket" );
    CHECK( binding.GetVersion() == 0x00010000U,           "GetVersion()" );
    CHECK( binding.GetPriority() == 40U,                  "GetPriority() == 40" );
